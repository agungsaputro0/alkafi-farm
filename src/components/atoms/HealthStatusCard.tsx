...
const HealthStatusCard: React.FC<HealthStatusCardProps> = ({
  ...
  return (
    <div onClick={() => navigate(`/ternak/kesehatan/${kodeNeckTagParam}`)} className="cursor-pointer bg-white hover:bg-farmlighestbrown rounded-xl shadow-md border border-gray-300 overflow-hidden w-full max-w-md md:max-w-2xl p-4 flex flex-col">
        ...
        <div className="flex flex-col justify-between md:w-2/3 px-1">
          <div>
            ...
            <div className="mt-4 text-sm">
              ...
              {pemeriksaanTerakhir
                ? formatTanggalIndo(pemeriksaanTerakhir.toString()) !== "Tanggal tidak valid"
                  ? formatTanggalIndo(pemeriksaanTerakhir.toString())
                  : "-"
                : "-"}
              </p>
            </div>
      ...
      <div className="mt-4 border-t pt-3">
        <p className="italic text-gray-700 font-semibold">Diagnosis Terakhir:</p>
