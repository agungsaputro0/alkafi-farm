...
const DanaDesaPanel: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const [targetDanaDesa, settargetDanaDesa] = useState({
          danaDesa: "",
        });
        ...
        const handleTargetChange = (field: keyof typeof targetDanaDesa, value: string) => {
          settargetDanaDesa((prev) => ({
            ...prev,
        ...
        const handleRealisasiChange = (field: keyof typeof realisasiDanaDesa, value: string) => {
          setRealisasiDanaDesa((prev) => ({
            ...prev,
            [field]: formatNumber(value),
          }));
        };
  return (
    <div className="rounded-xl shadow-md overflow-hidden">
      ...
      <div
        ...
        >
        <h2 className="text-xl font-semibold">Dana Desa</h2>
        <FaChevronDown
            ...
            <form /* onSubmit={handleFormSubmit} onKeyDown={handleKeyDown} */>
               <div className="grid grid-cols-3 gap-8">
                ...
                <div className="border-2 p-4 bg-kemenkeubluesoft rounded-xl border-dashed border-gray-400">
                    ...
                    <InputElement
                    inputClass="mb-6"
                    forwhat="danaDesaTarget"
                    labelMessage="Dana Desa"
                    typeInput="text"
                    inputName="danaDesaTarget"
                    inputPlaceholder="Masukkan angka"
                    value={targetDanaDesa.danaDesa}
                    onChange={(e) => handleTargetChange("danaDesa", e.target.value)}
                    />
                </div>
                ...
                <div className="p-4 rounded-xl bg-kemenkeuyellowsoft border-2 border-dashed border-gray-400">
                    ...
                    <InputElement
                    inputClass="mb-6"
                    forwhat="danaDesaRealisasi"
                    labelMessage="Dana Desa"
                    typeInput="text"
                    inputName="danaDesaRealisasi"
                    inputPlaceholder="Masukkan angka"
                    value={realisasiDanaDesa.danaDesa}
                    onChange={(e) => handleRealisasiChange("danaDesa", e.target.value)}
                    />
                </div>
                ...
                <div className="p-4 rounded-xl bg-kemenkeubluesoft/30 border-2 border-dashed border-gray-400">
                    ...
                    {[
                    { label: "Dana Desa", value: calculatePercentage(targetDanaDesa.danaDesa, realisasiDanaDesa.danaDesa) },
                    ].map((item) => {
