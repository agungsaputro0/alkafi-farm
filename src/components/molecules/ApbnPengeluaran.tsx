...
import FedaApbnPengeluaranDjpb from './FedaApbnPengeluaranDjpb';
import dayjs from "dayjs";

const ApbnPengeluaran = () => {
...
export default ApbnPengeluaran;
