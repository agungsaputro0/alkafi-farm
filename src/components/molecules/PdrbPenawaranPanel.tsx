...
const PdrbPenawaranPanel: React.FC = () => {
                ...
                {colLabels.map((_, cIdx) => {
                    ...
                    if (cIdx === 4) {
                        ...
                        <td key={cIdx} className={`px-1 py-1 ${bgClasses[cIdx]}`}>
                            <div className="w-full p-1 font-semibold text-center text-black border-b-2 border-blue-300 h-[37.7778px]">
  ...
  return (
    <div className="rounded-xl shadow-md overflow-hidden">
      ...
      >
        <h2 className="text-xl font-semibold">PDRB Penawaran</h2>
        <FaChevronDown
...
export default PdrbPenawaranPanel;
