...
const menuKey = import.meta.env.VITE_THIRD_KEY;

interface FedaApbdPendapatanProps {
   tahun: string;
  bulan: string;
  provinsi: string;
  provinsiText?: string;
...
interface TabWrapperProps extends FedaApbdPendapatanProps {
  tabId: string;
  tabName: string;
}
...
const FedaApbdPendapatanDjpb: React.FC<FedaApbdPendapatanProps> = ({
  tahun,
  bulan,
  provinsi,
  provinsiText,
...
export default FedaApbdPendapatanDjpb;
