...
import { useFetchProvinsi, useFetchInstansi } from '../hooks/HandleFeda';
import FedaApbdPendapatanDjpb from './FedaApbdPendapatanDjpb';
import dayjs from "dayjs";

const ApbdPendapatan = () => {
              ...
              <div className="w-full md:col-span-3">
                 <div className="w-full bg-white/10 backdrop-blur-md p-6 text-white mb-6">
                   ...
                   {isFormReady && instance === "Direktorat Jenderal Perbendaharaan" && (
                    ...
                    {(isFormReady && instance !== "Direktorat Jenderal Perbendaharaan" && selectedInstance !== "0") && (
                        <div className="w-full flex justify-center mb-4">
